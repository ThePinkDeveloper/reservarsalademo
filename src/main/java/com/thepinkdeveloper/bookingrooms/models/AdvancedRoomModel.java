...
public class AdvancedRoomModel {
	...
	public AdvancedRoomModel() {}

	public AdvancedRoomModel(String code, String name, Integer capacity, Integer elements, LocalDate date, Integer freeOccupancy) {
		super();
		this.code = code;
		this.name = name;
